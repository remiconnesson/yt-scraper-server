...
def reset_proxy_manager():
    """Reset the global proxy manager before and after each test."""
    import slides_extractor.downloader as downloader_module

    original_manager = downloader_module._proxy_manager
    yield
    downloader_module._proxy_manager = original_manager


class TestProxyRetryLogic:
    """Test suite for proxy retry functionality in downloader."""

    def test_get_proxy_config_returns_next_proxy(self):
    ...
    def test_mark_proxy_burnt_marks_proxy_as_unavailable(self):
    ...
    def test_download_file_single_no_retry_logic(self, tmp_path):
        ...
        import slides_extractor.downloader

        original_dir = slides_extractor.downloader.DOWNLOAD_DIR
        slides_extractor.downloader.DOWNLOAD_DIR = str(tmp_path)
        ...
        try:
            ...
            slides_extractor.downloader.DOWNLOAD_DIR = original_dir

    def test_no_proxy_config_uses_direct_connection(self):
